import 'package:ems_app/data/apiResponse/DeviceEnergyData.dart';
import 'package:ems_app/data/apiResponse/DeviceGetByIdResponse.dart';
import 'package:ems_app/resources/app_resources.dart';

class DeviceListResponse{
  final int result;
  final List<DeviceListData> data;

  DeviceListResponse({required this.result, required this.data});

  factory DeviceListResponse.fromJson(Map<String, dynamic> json) {
    var dataList = json['data'] as List<dynamic>;
    List<DeviceListData> dataItems = dataList.map((item) => DeviceListData.fromJson(item)).toList();
...
class DeviceVals {
  ...
  factory DeviceVals.fromJson(Map<String, dynamic> json) {
    ...
    return DeviceVals(
      reqAndInfo3444B8: int.tryParse(json['Req_And_Info_3444_B8'] ?? '') ?? 0,
      reqAndInfo3444B9: int.tryParse(json['Req_And_Info_3444_B9'] ?? '') ?? 0,
      info3441: json['info_3441'] ?? "",
      hb3450: hb3450 ?? 0,
      l2_3457: json['L2_3457'] ?? "0",
      l2_3460: double.tryParse(json['L2_3460'] ?? '') ?? 0,
      l2_3449: int.tryParse(json['L2_3449'] ?? '') ?? 0,
      reqAndInfo3488B8: int.tryParse(json['Req_And_Info_3488_B8'] ?? '') ?? 0,
      reqAndInfo3488B9: int.tryParse(json['Req_And_Info_3488_B9'] ?? '') ?? 0,
      hb3494: hb3494 ?? 0,
      l2_3501: json['L2_3501'] ?? '0',
      l2_3504: double.tryParse(json['L2_3504'] ?? '') ?? 0,
      l2_3493: int.tryParse(json['L2_3493'] ?? '') ?? 0,
      info3529: json['info_3529'] ?? "",
      info3485: json['info_3485'] ?? "",
      reqAndInfo3532B8: int.tryParse(json['Req_And_Info_3532_B8'] ?? '') ?? 0,
      reqAndInfo3532B9: int.tryParse(json['Req_And_Info_3532_B9'] ?? '') ?? 0,
      hb3538: hb3538 ?? 0,
      l2_3545: json['L2_3545'] ?? "0",
      l2_3548: double.tryParse(json['L2_3548'] ?? '') ?? 0,
      l2_3537: int.tryParse(json['L2_3537'] ?? '') ?? 0,
      l2_3540: json['L2_3540'] ?? "",
      info3573: json['info_3573'] ?? "0",
      reqAndInfo3576B8: int.tryParse(json['Req_And_Info_3576_B8'] ?? '') ?? 0,
      reqAndInfo3576B9: int.tryParse(json['Req_And_Info_3576_B9'] ?? '') ?? 0,
      hb3582: hb3582 ?? 0,
      l2_3589: json['L2_3589'] ?? '0',
      l2_3592: double.tryParse(json['L2_3592'] ?? '') ?? 0,
      l2_3581: int.tryParse(json['L2_3581'] ?? '') ?? 0,
      l2_3584: json['L2_3584'] ?? "",

      reqAndInfo3044: int.tryParse(json['Req_And_Info_3044'] ?? '') ?? 2,
